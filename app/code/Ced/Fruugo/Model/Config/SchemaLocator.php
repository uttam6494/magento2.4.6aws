 ...
 */
namespace Ced\Fruugo\Model\Config;
...
class SchemaLocator extends \Magento\Config\Model\Config\SchemaLocator
{
    		...
    		\Magento\Framework\Module\Dir\Reader $moduleReader)
    {
    	...
    	if($this->_objectManager->get('Magento\Framework\Module\Manager')->isEnabled('Ced_Fruugo'))
    	{
	        $etcDir = $moduleReader->getModuleDir(\Magento\Framework\Module\Dir::MODULE_ETC_DIR, 'Ced_Fruugo');
