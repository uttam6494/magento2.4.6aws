...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset  
{
    ...
    public function __construct(
        ...
        $this->_helper = $this->_objectManager->get('Ced\Fruugo\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
		...
		$modules =  $this->_objectManager->get('\Ced\Fruugo\Helper\Feed')->getAllModules();
    ...
    {
    	$hash = \Ced\Fruugo\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_hash';
    	$level = \Ced\Fruugo\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_level';

	 	$helper = $this->_objectManager->create('\Ced\Fruugo\Helper\Data');
		...
		$l = $this->_objectManager->create('\Ced\Fruugo\Helper\Feed')->getLicenseFromHash($hash,$level);
