...
class Mapsave extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (isset($data)) {
            $fruugoCodeCol = $this->_objectManager->create('Ced\Fruugo\Model\Confattributes')->getCollection();
            $model = $this->_objectManager->create('Ced\Fruugo\Model\Confattributes');
            ...
            $this->messageManager->addSuccessMessage(__('Configurable Attributes Mapped Successfully.'));
        } else {
